    ...
    const topic_id = this.props?.match?.params?.id;
      ...
      return (
        <section className="detailed-topic-box">
          <EditTopic cancelEdit={this.handleCancelEditTopic} topicId={topic_id} title={topicContent.title} rpg_system={topicContent.rpg_system} topic_desc={topicContent.topic_desc} />
        </section>
      )
    } else {
      return (
